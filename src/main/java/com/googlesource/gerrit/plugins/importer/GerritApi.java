  ...
  class Version implements Comparable<Version> {
    ...
    Version(String formatted) {
      ...
      if (m.matches()) {
        ...
        this.patch = m.group(3) != null ? Integer.parseInt(m.group(3)) : null;
        this.patch2 = m.group(4) != null ? Integer.parseInt(m.group(4)) : null;
        this.qualifier = m.group(5) != null ? m.group(5) : null;
      } else {
        this.major = null;
        this.minor = null;
        this.patch = null;
